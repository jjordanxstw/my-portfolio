			...
			<div className="flex flex-col md:flex-row items-center justify-between w-full gap-12">
				<div className="flex-1 text-left">
					...
					<p className="animated-line text-lg md:text-xl opacity-70 mb-8">
						I love building web and mobile apps that make everyday
						experiences a little smoother and more enjoyable.
					</p>
					<div className="flex gap-4">
						<a
							href="#projects"
							className="animated-line inline-block bg-white text-black px-8 py-5 rounded-full font-semibold hover:bg-gray-200 transition-all duration-200 hover:scale-110 hover:shadow-2xl shadow-lg active:scale-95"
							style={{
						...
						<a
							href="#contact"
							className="animated-line inline-block bg-transparent border-2 border-white text-white px-8 py-5 rounded-full font-semibold hover:bg-white hover:text-black transition-all duration-200 hover:scale-110 active:scale-95"
							style={{
								transitionTimingFunction:
									"cubic-bezier(0.34, 1.56, 0.64, 1)",
							}}
			...
			<div className="grid gap-8 md:grid-cols-2">
				<div className="animated-line space-y-6">
					<p className="text-lg opacity-90 leading-relaxed">
						...
						web development started with a curiosity about how
						things work on the web, and has evolved into a deep love
						for crafting pixel-perfect designs and smooth
						animations.
					</p>
					<p className="text-lg opacity-90 leading-relaxed">
						I specialize in React, Next.js, Three.js, and modern CSS
						frameworks. I believe in writing clean, maintainable
				...
				{[
					{
						...
						description:
							"An immersive 3D portfolio built with Three.js and React Three Fiber, featuring interactive models and smooth animations.",
					...
					},
					{
						...
						description:
							"A modern chat application with WebSocket support, file sharing, and end-to-end encryption.",
					...
					},
					{
						...
						description:
							"Web app that generates images from text prompts using AI APIs with a beautiful gallery interface.",
					...
					},
					{
						...
						description:
							"Beautiful weather dashboard with interactive maps, forecasts, and data visualizations.",
			...
			<div className="mt-8 space-y-6">
				{[
					...
					},
					{
						...
						period: "2022 - 2023",
						description:
							"Developed custom web solutions for clients, focusing on interactive experiences and modern web technologies.",
						achievements: [
					...
					},
					{
						...
						period: "2021 - 2022",
						description:
							"Contributed to building an MVP for a SaaS product, learned modern development practices and agile methodologies.",
						achievements: [
